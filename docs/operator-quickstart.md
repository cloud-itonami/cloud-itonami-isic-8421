# Operator Quickstart — Foreign Affairs and Consular Services Administration

Shortest path from clone to a verified local dry-run for **ISIC 8421** (`cloud-itonami-isic-8421`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-8421.git
cd cloud-itonami-isic-8421
```
...
- Blueprint governor key: `foreign-consular-governor`
- Likely source path: `foreign.governor.cljc`
